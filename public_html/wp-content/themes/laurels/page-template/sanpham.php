    ...
    <div id="leafContainer"></div> 
      <div class="header_bottom_sanpham">
        <div class="container webpage-container">
          ...
          <div class="col-md-12 no-padding ">
          	<div class="header_menu logo-sanpham">
            	<div class="col-sm-3 col-md-3 logo-display  no-padding logo-sanpham-1">
                	<a href="#"><img class="egcg egcg1" src="http://traxanhkhongdo.com.vn/wp-content/uploads/2016/11/egcg.png" /></a>
                    
                </div>
                <div class="col-sm-6 col-md-6 no-padding egcg-1 logo-sanpham-2">
                	<a href="#"><img class="egcg loi-ich-sk" src="http://traxanhkhongdo.com.vn/wp-content/uploads/2016/11/loi-ich-suc-khoe.png" /></a>                   
                </div>
                <div class="col-sm-3 col-md-3 no-padding egcg-1 logo-sanpham-3">
                	<a href="#"><img class="egcg egcg1 egcg-ungthu" src="http://traxanhkhongdo.com.vn/wp-content/uploads/2016/11/egcg-chong-ung-thu.png" /></a>                    
                </div>
            </div>
          </div>          
        </div> 
										...
										if ($category_num >=0) {												
												...
												while ($my_query->have_posts()){
                                                     ...
                                                     <?php $format = get_post_format($post->ID); ?>
                                                     	<?php if ($format != 'video') { ?>
															<a href="<?php echo get_permalink(); ?>" class=""><?php the_post_thumbnail( 'large' ); ?></a>
