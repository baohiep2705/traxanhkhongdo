			...
			<div class="col-xs-12 col-sm-9 col-md-9 col-lg-9">
				...
				<div class="content-800">
					...
					<ul>
						...
						<li><?php _e('Email opt-ins – perfect for collecting your visitor\'s e-mail addresses.', Opt_In::TEXT_DOMAIN); ?></li>
						
						<li><?php _e('Custom Content – create any kind of pop up, slide in, widget or shortcode. eg. An Ad.', Opt_In::TEXT_DOMAIN); ?></li>
