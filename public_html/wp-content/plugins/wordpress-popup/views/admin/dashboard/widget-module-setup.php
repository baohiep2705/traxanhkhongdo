	...
	<div class="box-content">
		...
		<div class="row">
			...
			<div class="col-xs-12">
				...
				<h6><?php _e('Choose below to create a simple e-mail opt-in or a custom content module for something like an ad.', Opt_In::TEXT_DOMAIN); ?></h6>
						...
						<?php if( true || !$has_optins ): ?>
							...
							<tr>
								...
								<td class="wph-dashstep--info">
									...
									<span class="wph-table--subtitle"><?php _e('Capture visitors\' e-mail addresses with a pop-up, slide-in, widget, or shortcode.', Opt_In::TEXT_DOMAIN); ?></span>
